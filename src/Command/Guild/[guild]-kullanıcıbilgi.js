...
\`•\` İsim geçmişi:  **${sayı}** (\`İsim Verisini Görmek İçin .isimler Komutunu Kullanabilirsiniz!\`)
`);
  if (üye.hasPermission("ADMINISTRATOR") || config.Yetkili.registerYT.some(x => üye.roles.cache.has(x))) 

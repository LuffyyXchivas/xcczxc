...
module.exports.beta = async(client, message, args) => {
    ...
    .setDescription(`
   ${emoji.kevzyyban} ${uye} Adlı Kullanıcı Sunucumuzdan Yasaklandı!
    ...
    `)
  message.channel.send(new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setDescription(`${uye} (\`${uye.id}\`) adlı kullanıcı sunucumuzdan banlandı!`).setColor("BLACK").setFooter(Main.Footer))
